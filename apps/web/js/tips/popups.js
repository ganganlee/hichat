function jqalert(param) {
    ...
    if (!notext) {
        ...
        htm += '<div class="fd-btn">' + '<a href="' + nolink + '"  data-role="cancel" class="cancel">' + notext + "</a>" + '<a href="' + yeslink + '" class="confirm"  id="yes_btn">' + yestext + "</a>" + "</div>";
        htm += "</div>"
    }
    $("body").append(htm);
    var al = $("#jq-alert");
